...
Once the `cryoem` channel has been enabled, `eman-deps, eman-deps-cli, eman-deps-dev` can be installed with:

```
conda install eman-deps eman-deps-cli eman-deps-dev
```
